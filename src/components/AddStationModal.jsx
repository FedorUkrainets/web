  ...
  return (
    <div className="modal-backdrop">
      <form className="modal" onSubmit={handleSubmit}>
        ...
        <input type="number" min="1" placeholder="Мощность, кВт" value={form.capacity_kw} onChange={(e) => setForm((p) => ({ ...p, capacity_kw: e.target.value }))} />
        <input type="number" min="0" placeholder="Текущая нагрузка, кВт" value={form.current_load_kw} onChange={(e) => setForm((p) => ({ ...p, current_load_kw: e.target.value }))} />
